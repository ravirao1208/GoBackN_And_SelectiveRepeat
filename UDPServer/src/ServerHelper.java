...
public class ServerHelper {
    ...
    public static ServerPacket decipherPacket(byte[] data) {
        ...
        /*
         * System.out.println("sequence Number : "+new
         * BigInteger(sequenceBytes).intValue()); System.out.println("checkSum : "+new
         * BigInteger(checkSum).intValue()); System.out.println("datatype : "+new
         * BigInteger(dataType).intValue());
         */
    ...
    // the function is used to convert the integer sequence number into bytes[] of
